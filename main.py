...
# ════════════════════════════════════════════════════════════════
# 3. Gemini 블로그 본문 생성 (네이버 블로그 최적화 HTML)
# ════════════════════════════════════════════════════════════════
...
def main():
    print("=" * 60)
    print("  냉부해 레시피 네이버 블로그 자동 발행 v4 (Gemini)")
    print("=" * 60)
